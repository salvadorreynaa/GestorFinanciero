        ...
        .then(empresas => {
          empresas.forEach(empresa => {
            ...
            li.innerHTML = `
              ...
              <span>
                <button class="btn-editar-opcion" title="Editar" data-valor="${empresa.nombre}">&#9998;</button>
                <button class="btn-eliminar-opcion" title="Eliminar" data-valor="${empresa.nombre}">&#128465;</button>
              </span>
            `;
        ...
        .then(tipos => {
          tipos.forEach(tipo => {
            ...
            li.innerHTML = `
              ...
              <span>
                <button class="btn-editar-opcion" title="Editar" data-valor="${tipo.nombre}">&#9998;</button>
                <button class="btn-eliminar-opcion" title="Eliminar" data-valor="${tipo.nombre}">&#128465;</button>
              </span>
            `;
            listaOpciones.appendChild(li);
          });
